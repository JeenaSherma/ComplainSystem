...
namespace ComplaintSystem.Migrations
{
    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "complainerInfos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ComplainerEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ComplainId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_complainerInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_complainerInfos_complains_ComplainId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tokens_complains_ComplainId",
                        column: x => x.ComplainId,
                        principalTable: "complains",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_qRinfos_municipalities_MunicipalityId",
                        column: x => x.MunicipalityId,
                        principalTable: "municipalities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_complainerInfos_ComplainId",
                table: "complainerInfos",
                column: "ComplainId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_departments_MunicipalityId",
                table: "departments",
